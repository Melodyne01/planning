 ...
 */
final class Version20240217165105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD created_by_id INT DEFAULT NULL, ADD color VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP created_by_id, DROP color');
    }
}
